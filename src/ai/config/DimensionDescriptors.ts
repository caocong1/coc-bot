  ...
  tiers: [
    {
      label: '自行摸索',
      instructions:
        '严格信息阻力：只回答玩家直接触发的信息。NPC 默认不配合——拒答、回避、试探、敷衍是常态，需要社交检定或充分 RP 才会透露有用信息。环境描述止步于氛围和公开可见事实，不暗示调查方向。',
    },
    {
      label: '少量提示',
      instructions:
        '可通过环境细节（异常气味、不寻常痕迹、NPC 微表情）暗示某处值得调查，但不揭示内容。NPC 在成功社交检定后配合度适中，但不主动展开，仍可能给出片面或带立场的信息。',
    },
    {
      label: '适度引导',
      instructions:
